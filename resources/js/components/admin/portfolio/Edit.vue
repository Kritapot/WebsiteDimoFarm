                    ...
                    <form role="form" @keydown="form.onKeydown($event)">
                        ...
                        <div class="card-footer">
                            <div class="col-lg-6 col-sm-12">
                                <button @click.prevent="updatePortfolio()" type="submit" class="btn btn-primary">บันทึก</button>
...
<script>
    export default {
        ...
        methods:{
            ...
            getApiPortfolio() {
                axios.get(`/portfolio/${this.$route.params.id}`).then((respon) => {
                    console.log(respon.data.portfolio)
                    this.form.fill(respon.data.portfolio)
                })
            },

            updatePortfolio() {
                this.form.post(`/update-portfolio/${this.$route.params.id}`).then(() => {
            ...
            updateImage(){
                ...
                if(img.length>100){
                    ...
                    return `uploadimage-portfolio/${this.form.photo}`
                }
            }
        }
    }
