                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 col-sm-12">
                                    ...
                                    <textarea class="form-control" v-model="form.description" id="" cols="100" rows="10" placeholder="รายละเอียดบทความ" name="description" :class="{ 'is-invalid': form.errors.has('description') }"></textarea>
